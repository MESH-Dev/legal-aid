...
function loadup_scripts() {
	...
	wp_enqueue_script( 'mix-js', get_template_directory_uri().'/js/mixitup.js', array('jquery'), '1.0.0', true );
    wp_enqueue_script( 'theme-js', get_template_directory_uri().'/js/mesh.js', array('jquery'), '1.0.0', true );
    //wp_enqueue_style( 'intake-css', get_template_directory_uri().'/css/intake.css', '1.0.0', true );
}
...
add_image_size('custom-post-thumbnail', 602, 328, array( 'center', 'center' ));
